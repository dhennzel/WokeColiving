...
CREATE TABLE `activity_logs` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1253 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `admin` VALUES (1,'Super Admin','super123','Super Admin','Admin','Super','superadmin@gmail.com','09956652352','admin_1_1777794212.png'),(6,'Stephen Squad PH','stephensquadph03','Super Admin','Stephen','Begosa','stephenbegosa@gmail.com','09662285702',NULL),(7,'admin1','admin123','Admin','Stephen','Squad','stephen@gmail.com','09874612545',NULL);
...
INSERT INTO `maintenance_requests` VALUES (8,NULL,36,'Routine Preventive Maintenance','Completed','2026-04-29','2026-04-29 05:56:37',400.00),(9,NULL,75,'Routine Preventive Maintenance','Completed','2026-04-30','2026-04-30 12:49:52',0.00);
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1626 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1499 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-03 16:29:49
