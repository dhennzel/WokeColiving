...
<html lang="en">
<head>
    <title>Housekeeping Requests | Dormitory</title>
...
<div class="container animate-fade-in" style="margin-top: 100px;">
    ...
    <?php } else { ?>
        <div class="alert alert-warning mb-5 anim-trigger delay-1"><i class="fas fa-exclamation-circle me-2"></i>You must have an active (approved) room reservation to request housekeeping services.</div>
    <?php } ?>
