...
// Find and hide Room 201
$room_number = '201';
$result = mysqli_query($conn, "SELECT room_id, room_number, is_hidden FROM rooms WHERE room_number = '$room_number' OR room_number LIKE '%201%'");
...
if(mysqli_num_rows($result) > 0) {
    ...
    echo "Room 201 (ID: $room_id) has been hidden from the dashboard.";
    echo "<br><a href='admin_dashboard.php'>Go back to Dashboard</a>";
} else {
    echo "Room 201 not found in the database.";
    echo "<br><a href='admin_dashboard.php'>Go back to Dashboard</a>";
}
?>
